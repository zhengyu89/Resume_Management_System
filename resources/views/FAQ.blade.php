...
<div class="faq-section">
  <h3 class="text-2xl font-semibold text-gray-700 mt-12 mb-4 border-b pb-1">🔹GENERAL</h3>
    <div class="faq-list space-y-4">
        ...
        <div class="faq-item border border-gray-300 rounded-md" data-question="{{ strtolower($faq['question']) }}">
            <button onclick="this.nextElementSibling.classList.toggle('hidden')" class="w-full text-left px-4 py-3 font-medium text-gray-800 bg-gray-100 hover:bg-gray-200 focus:outline-none">
                {{ $faq['question'] }}
            </button>
