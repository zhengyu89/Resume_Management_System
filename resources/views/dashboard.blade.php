                    ...
                    <div class="relative px-6 pb-6">
                        <div class="flex justify-center -mt-16">
                            <div class="relative">
                                <img class="h-32 w-32 rounded-full border-4 border-white shadow-lg object-cover" 
                                     ...
                                     alt="Profile Picture">
                                <button class="absolute bottom-2 right-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full p-2 shadow-lg transition-colors">
                        ...
                        <div class="mt-6 space-y-4">
                            <div class="flex items-center text-gray-600">
                                ...
                                <span class="text-sm">{{ $user->address ?? '123 Main St, City, State 12345' }}</span>
                            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="border-l-4 border-blue-500 pl-4 mb-6">
                            ...
                            <p class="text-gray-600">Lead development of web applications using modern frameworks. Collaborate with cross-functional teams to deliver scalable solutions.</p>
                        </div>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            ...
                            <p class="text-gray-600">Developed and maintained client websites and applications. Implemented responsive designs and optimized performance.</p>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="border-l-4 border-green-500 pl-4 mb-6">
                            <div class="flex justify-between items-start mb-2">
                                <h4 class="text-lg font-medium text-gray-900">Bachelor of Science in Computer Science</h4>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-lg mb-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-green-800">{{ basename($user->resume_file) }}</p>
                                    <p class="text-xs text-green-600">Uploaded on {{ $user->resume_uploaded_at ?? 'Unknown date' }}</p>
                                </div>
                            </div>
