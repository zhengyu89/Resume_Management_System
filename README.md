...
-   **Admin Dashboard**: A central dashboard for site-wide management.

-   **User Management**: View a list of all registered users and their assigned roles. Ability to delete user accounts from the system.

-   **Content Management**: Manage the selectable options available to users during profile creation to ensure data consistency.

-   **Languages**: Add or remove languages.

-   **Study Fields**: Add or remove academic fields of study.
